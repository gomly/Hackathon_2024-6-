    ...
    <div id="budget-section" class="home-middle-inner-container section1">
        ...
        <form method="post">
            ...
            <div class="slider-container">
                ...
                <input type="range" class="sliders-class" id="housingSlider" name="housing" min="0" max="250" value="0" oninput="updateSliderValues()">
            ...
            <div class="slider-container">
                ...
                <input type="range" class="sliders-class" id="groceriesSlider" name="groceries" min="0" max="100" value="0" oninput="updateSliderValues()">
            ...
            <div class="slider-container">
                ...
                <input type="range" class="sliders-class" id="leisureSlider" name="leisure" min="0" max="100" value="0" oninput="updateSliderValues()">
            ...
            <div class="slider-container">
                ...
                <input type="range" class="sliders-class" id="transportSlider" name="transport" min="0" max="100" value="0" oninput="updateSliderValues()">
